...
class Utils{
    ...
    public static function enviarCorreoConfirmacion(string $htmlContent, string $email): array {
        ...
        try {
            ...
            $mail->setFrom('rafapruebasdaw@gmail.com', 'CienAnuncios');
    ...
    public static function creaHtmlContentConfirmacion(Usuario $usuario): string {
        ...
        <a href="http://localhost/API_Anuncios/confirmar-cuenta/'.$usuario->getToken().'/'.$usuario->getEmail().'">Confirmar cuenta</a>
        </body></html>';
        return $htmlContent;
    }
